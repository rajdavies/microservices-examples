...
import io.fabric8.example.variance.msg.VarianceProcessor;
...
public class VarianceProcessorTest extends CamelTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:start").process(new VarianceProcessor()).to("mock:result");
            }
        };
    }
}
